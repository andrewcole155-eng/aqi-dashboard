...
if alerts:
    ...
    for alert in alerts:
        ...
        elif alert['level'] == "success": # <--- ADD THIS
            st.success(f"{alert['icon']} {msg}") # <--- ADD THIS
        else:
    ...
    with c2:
        ...
        if allocation_data:
            ...
            ASSET_INDEX_MAP = {
                ...
                # --- The New Additions ---
                'UBER': 'XLI',  # Industrials / Transports
                'GOLD': 'XLB',  # Materials / Precious Metals
                'CCL': 'XLY',   # Consumer Discretionary / Travel
